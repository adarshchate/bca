...
$sql = "SELECT rid,rno FROM rooms WHERE rid='$rti1'";
$rs = mysqli_query($con, $sql);

$sql1 = "SELECT rno FROM rooms WHERE rno='$rno1'";
...
<body>
    <div class="row">
        ...
        {
            echo "Add room  id= " . $rti1 . "<br>";
            echo "Add Rooms No= " . $rno1;

            $_SESSION['rrid'] = $rti1;
            $_SESSION['rrno'] = $rno1;

        ?>
            <form class="booking" action="addRooms3.php" method="post">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        echo " room no " . $rno1 . "is allready exits <br>";
                            ?>
                        </select><br>
                    </div>
                    <button class="button1" type="submit">Add Room </button>
                </div>

            </form>
        <?php  } else {

            echo " room id " . $rti1 . "is allready exits <br>";
        }
        ?>

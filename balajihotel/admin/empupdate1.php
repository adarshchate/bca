...
<body>
    <div class="row">
        ...
        <form class="booking" action="empupdate2.php" method="post">
            <div class="panel-body">
                <div class="form-group">
                    <label> Employee Id :</label> <br>
                    <input type="text" name="eaid" class="form-control" placeholder="E id" autocomplete="off" required>
                </div>

                <button class="button1" type="submit"> SELECT </button>
                <button class="button" onclick="javascript:window.open('empdelete.php','_self')"> Delete Employee </button>

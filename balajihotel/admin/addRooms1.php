...
<body>
    <div class="row">
        ...
        <hr>
        <form class="booking" action="addRooms2.php" method="post">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" name="rtid" class="form-control" autocomplete="off" pattern="[^/+*'a-zA-z:]*$"  required>
                </div>
                <div class="form-group">
                    <label> Room No : </label> <br>
                    <input type="text" name="rtno" class="form-control" minlength="4" autocomplete="off" pattern="[^/+*'a-z:]*$"  required>
                </div>

...
$busdb=$_SESSION['dbbase'];    // this is from to bus route for database 
...
$db=mysqli_select_db($con,"epiz_28874665_skytravel") or die("error in db");   //select database
...
if($rs>0)
{
  echo "Your Booking has been Done..!<br>get print your bill/Screen shot <br>Don't refresh page..!  ";
}
else
{
  echo "technical error...! Your booking is not submitted..! ";
  header('Refresh: 3; url=http://skytravel.rf.gd/booking.php');
}
...
<body>
    ...
    <div class="as" id="canvasDiv" align="center">
        ...
        <input class="button" id="printpagebutton" type="button" value="Print Bill" onclick="printpage() " /> <br>
        <input class="button1"  type="button" value="HOME" onclick="window.location.href='http://skytravel.rf.gd/booking.php' " />
    ...
    <script>
        ...
        function printpage() {
            ...
            //window.location.assign("http://skytravel.rf.gd/booking.php")
        }
    </script>
